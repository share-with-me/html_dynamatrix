...
Given the timeframe, only the tasks asked have been implemented but it can be very well possible to improve the UI significantly (eg: with added legends, proper setting of DOM elements, etc). It also contains a folder named 'Rickshaw.js_examples' which containes files which make use of Rickshaw.js, a visualisation library for time series analysis developed by shutterstock on d3.js
